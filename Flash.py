...
text = """ FASTEST, SMOOTHEST AND POWERFUL 𝐅𝐋𝐀𝐒𝐇 𝗦𝗣𝗔𝗠𝗕𝗢𝗧 DEPLOYED SUCCESSFULLY """

print(text)
print("")
print("SMEX! 𝐅𝐋𝐀𝐒𝐇 𝗦𝗣𝗔𝗠𝗕𝗢𝗧 STARTED.")
